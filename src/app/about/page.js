    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-amber-50 to-orange-50">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold text-center mb-8 text-gray-800">サイトについて</h1>

          <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-lg mb-8">
            <CardContent className="p-8">
              <h2 className="text-2xl font-bold mb-4 text-rose-600">関西カフェ検索について</h2>
              ...
              <h2 className="text-2xl font-bold mb-4 text-amber-600">運営について</h2>
          ...
          <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-lg">
            <CardContent className="p-8">
              <h2 className="text-2xl font-bold mb-4 text-rose-600">サイトの使い方</h2>
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-bold mb-2 text-gray-800">カフェを探す</h3>
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2 text-gray-800">お気に入り機能</h3>
                  <p className="text-gray-700">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2 text-gray-800">詳細情報の確認</h3>
                  <p className="text-gray-700">
